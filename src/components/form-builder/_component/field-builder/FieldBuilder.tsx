...
import { initialFields } from '@/components/form-builder/_component/field-builder/initial-fields';
import { useFieldBuilder } from '@/components/form-builder/_component/field-builder/useFieldBuilder';

export function FieldBuilder() {
  const { fields, addField, editField, deleteField, reorderField } = useFieldBuilder(initialFields);
